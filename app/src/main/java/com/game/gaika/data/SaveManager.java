...
public class SaveManager {
    public static class ShowSaveNode {
        ...
        public SCENE_ID preSceneId;

        public ShowSaveNode(int pSaveNo, String pDateTime, int pTurnCount, String pChapterName, SCENE_ID pPreSceneID) {
            saveNo = pSaveNo;
            dateTime = pDateTime;
    ...
    public static Map<Integer, ShowSaveNode> getSaves(int pPage) {
        ...
        for (int i = saveNoBegin; i < saveNoEnd; i++) {
            saves.put(i, new ShowSaveNode(0, "", 0, "", SCENE_ID.BEGIN_MENU));
        }
        ...
        while (cursor.isAfterLast() == false) {
            ...
            SCENE_ID preSceneId = SCENE_ID.valueOf(cursor.getString(cursor.getColumnIndex("pre_scene_id")));
    ...
    public static void save(int pSaveNo) {
        ...
        GameDataManager gdm = GameDataManager.getInstance();
        SCENE_ID pPerSceneId;
        if (pSaveNo <= 20 * 99) {
            pPerSceneId = SceneManager.getTopBaseLogicScene().getPreSceneID();
