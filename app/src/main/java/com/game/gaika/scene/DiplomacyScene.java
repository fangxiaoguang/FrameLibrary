 ...
 */
public class DiplomacyScene extends SimpleScene {
...
//        MSG_SELECT_COUNTRY_6, MSG_CAN_BUY_WEAPON_NEXT}
    ...
    public DiplomacyScene(boolean isInit) {
        super(SCENE_ID.DIPLOMACY, 800.0f, 600.0f, GameSetup.deviceWidthPixels, GameSetup.deviceHeightPixels);
        ...
        NormalSprite leftSprite = new NormalSprite(53, 217, "oper_bt7", 2, new TouchMessage(MSG_ID.MSG_SCENE_DIPLOMACY__LEFT, null, this));
       ...
       // beginDipLv = gdm.getDiplomacy(selectedCounty);
        ...
        TextSprite textSprite = new TextSprite(108, 159, true, selectedCountry.toDescribeString(), getFont16());
...
//        addSprite(barSprite1);
        ...
        NormalSprite rightSprite = new NormalSprite(484, 217, "oper_bt7", 3, new TouchMessage(MSG_ID.MSG_SCENE_DIPLOMACY__RIGHT, null, this));
        addSprite(rightSprite);

        NormalSprite confirmSprite = new NormalSprite(593, 234, "oper_bt8", 1, new TouchMessage(MSG_ID.MSG_SCENE_DIPLOMACY__CONFIRM, null, this));
        ...
        if (selectedCountry == USA) {
            ...
            NormalSprite countySprite = new NormalSprite(576, 342, "invisible34_21", 0, new TouchMessage(MSG_ID.MSG_SCENE_DIPLOMACY__SELECT_COUNTRY_1, null, this));
            addSprite(countySprite);
        }
        ...
        if (selectedCountry == USN) {
            ...
            NormalSprite countySprite = new NormalSprite(511, 380, "invisible34_21", 0, new TouchMessage(MSG_ID.MSG_SCENE_DIPLOMACY__SELECT_COUNTRY_2, null, this));
            addSprite(countySprite);
        }
        ...
        if (selectedCountry == RUSSIA) {
            ...
            NormalSprite countySprite = new NormalSprite(253, 305, "invisible34_21", 0, new TouchMessage(MSG_ID.MSG_SCENE_DIPLOMACY__SELECT_COUNTRY_3, null, this));
            addSprite(countySprite);
        }
        ...
        if (selectedCountry == GERMANY) {
            ...
            NormalSprite countySprite = new NormalSprite(191, 334, "invisible34_21", 0, new TouchMessage(MSG_ID.MSG_SCENE_DIPLOMACY__SELECT_COUNTRY_4, null, this));
            addSprite(countySprite);
        }
        if (selectedCountry == ENGLAND) {
            ...
            NormalSprite countySprite = new NormalSprite(135, 315, "invisible34_21", 0, new TouchMessage(MSG_ID.MSG_SCENE_DIPLOMACY__SELECT_COUNTRY_5, null, this));
            addSprite(countySprite);
        }
        if (selectedCountry == JAPAN) {
            ...
            NormalSprite countySprite = new NormalSprite(374, 365, "invisible34_21", 0, new TouchMessage(MSG_ID.MSG_SCENE_DIPLOMACY__SELECT_COUNTRY_6, null, this));
            addSprite(countySprite);
        }
    ...
    public void onHandlMessage(TouchMessage pTouchMessage) {
        ...
        SceneValueMap sceneValues =  getSceneValuesMap();
        if (msgID == MSG_ID.MSG_SCENE_DIPLOMACY__SELECT_COUNTRY_1) {
             playSound("select01");
        ...
        if (msgID == MSG_ID.MSG_SCENE_DIPLOMACY__SELECT_COUNTRY_2) {
             playSound("select01");
        ...
        if (msgID == MSG_ID.MSG_SCENE_DIPLOMACY__SELECT_COUNTRY_3) {
             playSound("select01");
        ...
        if (msgID == MSG_ID.MSG_SCENE_DIPLOMACY__SELECT_COUNTRY_4) {
             playSound("select01");
        ...
        if (msgID == MSG_ID.MSG_SCENE_DIPLOMACY__SELECT_COUNTRY_5) {
             playSound("select01");
        ...
        if (msgID == MSG_ID.MSG_SCENE_DIPLOMACY__SELECT_COUNTRY_6) {
             playSound("select01");
        ...
        if (msgID == MSG_ID.MSG_SCENE_DIPLOMACY__LEFT) {
             playSound("select01");
        ...
        if (msgID == MSG_ID.MSG_SCENE_DIPLOMACY__RIGHT) {
             playSound("select01");
            //int lv = sceneValues.getInt("selectedDiplomacyLv");
            ID.COUNTRY selectedCountry = (ID.COUNTRY)sceneValues.getEnum("selectedCounty");
            int nowLv = gdm.getDiplomacy(selectedCountry);
        ...
        if (msgID ==MSG_ID.MSG_SCENE_DIPLOMACY__CONFIRM) {
        ...
        if(msgID == MSG_ID.MSG_SCENE_DIPLOMACY__CAN_BUY_WEAPON_NEXT){
             playSound("scrl01");
            List<Integer> infoIDs = (List<Integer>)(sceneValues.getObject("newWeaponInfoIds"));
            infoIDs.remove(0);
            DiplomacyScene scene = new DiplomacyScene(false);
    ...
    private List<Integer>  getNewInfoIDs(Enum pCountry ,int pNowLv, int pEndLv){
        ...
        SQLiteDatabase dbData = DatabaseManager.getSqLiteDatabase(GameSetup.sdcartdPahtDB + "data.db");//SQLiteDatabase.openDatabase(GameSetup.sdcartdPahtDB + "data.db", null, SQLiteDatabase.OPEN_READWRITE);
