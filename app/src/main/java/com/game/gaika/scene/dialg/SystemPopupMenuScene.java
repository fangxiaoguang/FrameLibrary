...
import static com.game.frame.scene.SCENE_ID.SYSTEM_POPUP_MENU;
...
public class SystemPopupMenuScene extends DialogScene {   // DialogScene {
    ...
    public SystemPopupMenuScene(/*IMessageHandler pMessageHandler,*/ BaseLogicScene pParentScene, float pScale) {
        ...
        if (pParentScene.getSceneId() == SCENE_ID.BATTLEFIELD) {
            NormalSprite button1 = new NormalSprite(x, y, "mainmenu", 0, new TouchMessage(MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_1, null, this));
        ...
        if (pParentScene.getSceneId() == SCENE_ID.BATTLEFIELD) {
            NormalSprite button2 = new NormalSprite(x, y, "mainmenu", 1, new TouchMessage(MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_2, null, this));
        ...
        if (pParentScene.getSceneId() == SCENE_ID.BATTLEFIELD) {
            NormalSprite button3 = new NormalSprite(x, y, "mainmenu", 2, new TouchMessage(MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_3, null, this));
        ...
        NormalSprite button4 = new NormalSprite(x, y, "mainmenu", 3, new TouchMessage(MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_4, null, this));
        button4.setScale(pScale);
        addSprite(button4);
        y += 35 * pScale;

        NormalSprite button5 = new NormalSprite(x, y, "mainmenu", 4, new TouchMessage(MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_5, null, this));
        button5.setScale(pScale);
        addSprite(button5);
        y += 35 * pScale;

        NormalSprite button6 = new NormalSprite(x, y, "mainmenu", 5, new TouchMessage(MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_6, null, this));
        button6.setScale(pScale);
        addSprite(button6);
        y += 35 * pScale;

        NormalSprite button7 = new NormalSprite(x, y, "mainmenu", 6, new TouchMessage(MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_7, null, this));
        button7.setScale(pScale);
        addSprite(button7);
        y += 35 * pScale;

        NormalSprite button8 = new NormalSprite(x, y, "mainmenu", 7, new TouchMessage(MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_8, null, this));
    ...
    public void onHandlMessage(TouchMessage pTouchMessage) {
        ...
        if (msgID == MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_1) {
            playSound("messag01");
            TurnFinishAction act = new TurnFinishAction();
            act.doAction();
        }
        if (msgID == MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_2) {
            playSound("select01");
            BattlefieldInfoAction act = new BattlefieldInfoAction();
            act.doAction();
        }
        if (msgID == MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_3) {
            playSound("select01");
            TeamListAction act = new TeamListAction();
            act.doAction();
        }

        if (msgID == MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_4) {
            playSound("select01");
        ...
        if (msgID == MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_5) {
            playSound("select01");
            DataLoadAction act = new DataLoadAction();
            act.doAction();
        }

        if (msgID == MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_6) {
            playSound("select01");
            SettingAction act = new SettingAction();
            act.doAction();
        }
        if (msgID == MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_7) {
            playSound("messag01");
            GameOverAction act = new GameOverAction();
            act.doAction();
        }
        if (msgID == MSG_ID.MSG_SCENE_SYSTEM_POPUP_MENU__BUTTON_8) {
            playSound("back01");
