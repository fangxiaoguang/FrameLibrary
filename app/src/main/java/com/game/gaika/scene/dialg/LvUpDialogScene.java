...
import com.game.frame.sprite.AnimeSprite;
...
public class LvUpDialogScene extends DialogScene {
    ...
    public LvUpDialogScene(int pWeaponID, BaseLogicScene pParentScene) {
        super(SCENE_ID.LV_UP_DIALOG, 0.0f, 0.0f, 406.0f, 142.0f, pParentScene, EPointModel.POINT_MODEL_CENTER);
        ...
        DelaySprite delaySprite = new DelaySprite(index1.size() * GameSetup.DELAY_LV_UP_S, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD__LV_UP_TIME_OUT, null, pParentScene, pWeaponID));
