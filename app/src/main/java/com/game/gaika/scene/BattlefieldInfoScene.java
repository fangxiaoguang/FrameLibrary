 ...
 */
public class BattlefieldInfoScene extends SimpleScene {

    //enum MSG_ID {MSG_RETURN}
    //private ID.SCENE_ID parentSceneID;

    public BattlefieldInfoScene(SCENE_ID pParentSceneID) {
        super(SCENE_ID.BATTLEFIELD_INFO, 800.0f, 600.0f, GameSetup.deviceWidthPixels, GameSetup.deviceHeightPixels);
        ...
        NormalSprite buttonRetSprite = new NormalSprite(144, 452, "retn_bt1", 0, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD_INFO__RETURN, null, this));
...
//        addChildScene(new borderSubScene(this));
    ...
    public void onHandlMessage(TouchMessage pTouchMessage) {
        ...
        if (msgID == MSG_ID.MSG_SCENE_BATTLEFIELD_INFO__RETURN) {
