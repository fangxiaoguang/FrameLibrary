...
public class BattlefieldEnterInfoHUDScene extends HUDScene {
    ...
    public BattlefieldEnterInfoHUDScene(float pWidth, float pHeight, IMessageHandler pMessageHandler, int pNewSelectedChapterID) {
        super(SCENE_ID.BATTLEFIELD_ENTER_INFO_HUD,pWidth, pHeight);
    ...
    public void buildScene() {
        ...
        NormalSprite bt1Sprite = new NormalSprite(width - 279 * unZoom, 23 * unZoom, "adva_bt2", 2, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD_ENTER_INFO_HUD__BUTTON1, null, messageHandler));
        bt1Sprite.setScale(unZoom);
        bt1Sprite.setId("bt_001");
        addSprite(bt1Sprite);

        NormalSprite bt2Sprite = new NormalSprite(width - 141 * unZoom, 23 * unZoom, "adva_bt2", 3, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD_ENTER_INFO_HUD__BUTTON2, null, messageHandler));
        bt2Sprite.setScale(unZoom);
        bt2Sprite.setId("bt_002");
        addSprite(bt2Sprite);
        ...
        //---------------------------------------
        Set<WEAPON_TYPE> weaponTypeSet = new HashSet<>();
        ...
        while (cursor.isAfterLast() == false) {
            ...
            TEAM_COLOR teamColor = TEAM_COLOR.valueOf(cursor.getString(cursor.getColumnIndex("team_color")));
