...
public class BlueRepairYesNoDialog  extends DialogScene {
    public BlueRepairYesNoDialog(BaseLogicScene pParentScene, int pWeaponID, int pFromLifeEx, int pToLifeEx, int pNeedSupply) {
        super(SCENE_ID.BLUE_REPAIR_YES_NO_DIALOG, 0.0f, 0.0f, 406, 185, pParentScene, EPointModel.POINT_MODEL_CENTER);
       ...
       BaseWeapon blueNode =  gdm.weapons.get(pWeaponID);
        ...
        NormalSprite buttonYesSprite = new NormalSprite(43, 137, "dialg6bt", 0, new TouchMessage(  MSG_ID.MSG_SCENE_BATTLEFIELD__BLUE_REPAIR_YES, null, pParentScene, pWeaponID) );
        addSprite(buttonYesSprite);
        NormalSprite buttonNoSprite = new NormalSprite(287, 137, "dialg6bt", 1, new TouchMessage(  MSG_ID.MSG_SCENE_BATTLEFIELD__BLUE_REPAIR_NO, null, pParentScene, pWeaponID));
