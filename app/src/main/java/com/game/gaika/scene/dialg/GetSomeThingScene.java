...
public class GetSomeThingScene extends DialogScene {
    ...
    public GetSomeThingScene(int pWeaponID, BaseLogicScene pParentScene) {
        super(SCENE_ID.GET_SOME_THING_DIALG, 0.0f, 0.0f, 376.0f, 256.0f + 88.0f, pParentScene, EPointModel.POINT_MODEL_CENTER);
        ...
        if (city.getWeaponInfoId != -1) {
            ...
            addSprite(new DelaySprite(GameSetup.DELAY_GET_SOME_THING_S, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD__GET_SOME_THING_TIME_OUT, null, pParentScene, weapon.id)));
