 ...
 */
public class SettingScene extends SimpleScene {


//    enum MSG_ID {MSG_RETURN}

    public SettingScene(boolean pInit, SCENE_ID pPreSceneID) {
        super(SCENE_ID.SETTING,  800.0f, 600.0f, GameSetup.deviceWidthPixels, GameSetup.deviceHeightPixels);
...
//        TiledSprite zoomText = getZoomSprite(465, 426, GameSetup.ZOOM);
        ...
        NormalSprite button2 = new NormalSprite(600 - 67, 420, "oper_bt7", 3, new TouchMessage(MSG_ID.MSG_SCENE_SETTING_ZOOM_UP, null, this, 0));
        addSprite(button2);
        ...
        if (GameSetup.settingOpenSound == true) {
            ...
            NormalSprite btnSoundOff = new NormalSprite(494, 470, "conf_bt1", 3, new TouchMessage(MSG_ID.MSG_SCENE_SETTING_SOUND_OFF, null, this, 0));
            addSprite(btnSoundOff);

        } else {
            NormalSprite btnSoundOn = new NormalSprite(384, 470, "conf_bt1", 2, new TouchMessage(MSG_ID.MSG_SCENE_SETTING_SOUND_ON, null, this, 0));
            addSprite(btnSoundOn);
        ...
        NormalSprite button4 = new NormalSprite(600 - 67, 420 + offY, "oper_bt7", 3, new TouchMessage(MSG_ID.MSG_SCENE_SETTING_VOLUME_UP, null, this, 0));
        addSprite(button4);


        //返回按钮
        NormalSprite buttonRetSprite = new NormalSprite(35, 556, "retn_bt1", 0, new TouchMessage(MSG_ID.MSG_SCENE_SETTING_RETURN, null, this, 0));
    ...
    public void onHandlMessage(TouchMessage pTouchMessage) {
        ...
        if (msgID == MSG_ID.MSG_SCENE_SETTING_ZOOM_DOWN) {
            playSound("back01");
        ...
        if (msgID == MSG_ID.MSG_SCENE_SETTING_ZOOM_UP) {
            playSound("back01");
        ...
        if (msgID == MSG_ID.MSG_SCENE_SETTING_SOUND_OFF) {
        ...
        if (msgID == MSG_ID.MSG_SCENE_SETTING_SOUND_ON) {
        ...
        if (msgID == MSG_ID.MSG_SCENE_SETTING_VOLUME_DOWN) {
            playSound("back01");
        ...
        if (msgID == MSG_ID.MSG_SCENE_SETTING_VOLUME_UP) {
            playSound("back01");
        ...
        if (msgID == MSG_ID.MSG_SCENE_SETTING_RETURN) {
            playSound("back01");
