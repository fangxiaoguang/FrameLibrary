...
//------------------------
            ...
            battlefieldScene.addSprite(new DelaySprite(GameSetup.DELAY_AI_BUY_NEXT_S, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD__AI_BUY_NEXT, null, battlefieldScene)));
            battlefieldScene.getLogicCamera().setCente( new Pair<Float, Float>( tCity.getPixelX(), tCity.getPixelY()));
            SceneManager.render(battlefieldScene);
//------------------

        } else {
            BattlefieldScene battlefieldScene = new BattlefieldScene(false);
            battlefieldScene.addSprite(new DelaySprite(GameSetup.DELAY_SHORT_S, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD__AI_BUY_TIME_OUT, null, battlefieldScene)));
            SceneManager.render(battlefieldScene);
        }
    }
}
