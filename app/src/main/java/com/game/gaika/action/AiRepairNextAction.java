...
public class AiRepairNextAction implements BaseAction {
    ...
    public void doAction() {
        ...
        if (canRepairWeapon != null) {
            ...
            BattlefieldScene battlefieldScene = new BattlefieldScene(false);
            battlefieldScene.addSprite(new DelaySprite(GameSetup.DELAY_SHORT_S, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD__AI_REPAIR_TIME_OUT, null, battlefieldScene)));
            SceneManager.render(battlefieldScene);
            repairWeapons = null;
        }
    }
