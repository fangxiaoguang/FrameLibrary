...
public class AiSelectWeaponTimeOutAction implements BaseAction {
    ...
    public void doAction() {
        ...
        if(descPoint != null) {
            ...
            battlefieldScene.addSprite(new DelaySprite(aiWeapon.path.size() * GameSetup.DELAY_PATH_S, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD__AI_MOVE_TO_DESC_TIME_OUT, null, battlefieldScene, aiWeaponID)));
        }else {

            battlefieldScene.addSprite(new DelaySprite(1 * GameSetup.DELAY_PATH_S, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD__AI_MOVE_TO_DESC_TIME_OUT, null, battlefieldScene, aiWeaponID)));
        }
