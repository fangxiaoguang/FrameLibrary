...
public class CapliuringTimeOutAction implements BaseAction {
    ...
    public void doAction() {
        ...
        if (city != null && (city.getWeaponInfoId != -1 || city.getMoney != 0 || city.getSupply != 0)) {
            ...
            BattlefieldScene battlefieldScene = new BattlefieldScene(false);
            battlefieldScene.addSprite(new DelaySprite(GameSetup.DELAY_SHORT_S, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD__GET_SOME_THING_TIME_OUT, null, battlefieldScene, weaponID)));
            SceneManager.render(battlefieldScene);
        }
    }
}
