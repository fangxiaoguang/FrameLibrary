      ...
      //  weapon.doMoveEnd();
       // weapon.selected = false;
        if (weapon.getLv() > weapon.getPreLv()) {
            ...
            BattlefieldScene battlefieldScene = new BattlefieldScene(false);
            battlefieldScene.addSprite(new DelaySprite(GameSetup.DELAY_SHORT_S, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD__LV_UP_TIME_OUT, null, battlefieldScene, weaponID)));
            SceneManager.render(battlefieldScene);
        }
