...
public class AiFightTimeOutAction implements BaseAction {
    ...
    public void doAction() {
        ...
        if (weapon.getLv() > weapon.getPreLv()) {
            ...
            BattlefieldScene battlefieldScene = new BattlefieldScene(false);
            battlefieldScene.addSprite(new DelaySprite(GameSetup.DELAY_SHORT_S, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD__LV_UP_TIME_OUT, null, battlefieldScene, aiWeaponID)));
            SceneManager.render(battlefieldScene);
        }
    }
}
