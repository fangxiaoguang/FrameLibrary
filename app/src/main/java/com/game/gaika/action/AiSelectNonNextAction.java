...
//            battlefieldScene.getLogicCamera().setCente(aiWeapon.getPixelX(), aiWeapon.getPixelY());
            battlefieldScene.getLogicCamera().setCente(new Pair<Float, Float>(strategic.getCameraMapPoont().getPixelX(), strategic.getCameraMapPoont().getPixelY()));
            battlefieldScene.addSprite(new DelaySprite(GameSetup.DELAY_AI_LOOP_S, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD__AI_SELECT_WEAPON_TIME_OUT, null, battlefieldScene, aiWeapon.id)));
...
//            items.clear();
            BattlefieldScene battlefieldScene = new BattlefieldScene(false);
            battlefieldScene.addSprite(new DelaySprite(GameSetup.DELAY_SHORT_S, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD__AI_SELECT_NON_TIME_OUT, null, battlefieldScene)));
            SceneManager.render(battlefieldScene);
            aiWeapons = null;
        }
