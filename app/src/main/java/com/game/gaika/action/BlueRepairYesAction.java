...
//        canRepairWeapon.life = toLifeEx * BaseWeapon.LIFE_PER_LIFE_EX;
        ...
        battlefieldScene.addSprite(new DelaySprite(GameSetup.DELAY_SHORT_S, new TouchMessage(MSG_ID.MSG_SCENE_BATTLEFIELD__BLUE_REPAIR_NEXT, null, battlefieldScene)));
