...
import com.game.frame.graph.MyScreenGrabber;
import com.game.frame.graph.MyScreenGrabber.IMyScreenGrabberCallback;
 ...
 */
public class MyScreenCapture extends Entity implements IMyScreenGrabberCallback {
    // ===========================================================
    // Constants
    // ===========================================================
    ...
    private final MyScreenGrabber mScreenGrabber = new MyScreenGrabber();
    ...
    public void onScreenGrabbed(final Bitmap pBitmap) {
        try {
            MyScreenCapture.saveCapture(pBitmap, this.mFilePath);
